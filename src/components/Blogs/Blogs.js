    ...
    return (
        <div>
            ...
            <div className='flex justify-center mt-5 mb-48'>
                <div className="accordion accordion-flush w-3/4" id="accordionFlushExample">
                    <div className="accordion-item border-t-0 border-l-0 border-r-0 rounded-none bg-white border border-gray-200">
                        ...
                        <div id="flush-collapseOne" className="accordion-collapse border-0 collapse show"
                            ...
                            <div className="accordion-body py-4 px-5">Authorization is the action which is taken to verify who is someone by accessing their information such as name, image, address etc. Another way, If a system has to verify a user who tries to access a protected file or data, then this is called authentication system.
